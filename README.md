## This is just a fork of the [nestjs/swagger](https://github.com/nestjs/swagger) with changes made by [mateusppereira](https://github.com/mateusppereira/swagger/tree/fix-schema-for-enum) rebased on top of more recent version of original repo.
